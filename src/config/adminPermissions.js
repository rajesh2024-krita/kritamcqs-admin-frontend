export const MODULES = [
  ...
  { key: "subscription-page-builder", label: "Page Builder", path: "/subscription-page-builder" },
  { key: "dashboard-carousel", label: "Dashboard Carousel", path: "/dashboard-carousel" },
  { key: "app-usage", label: "Analytics", path: "/app-usage" },
  { key: "policy-pages", label: "Policy Management", path: "/policy-pages" },
  { key: "cms-pages", label: "CMS Pages", path: "/cms-pages" },
  { key: "cms-menu-items", label: "CMS Menus", path: "/cms-menus" },
  { key: "website-settings", label: "Website Settings", path: "/website-settings-builder" },
  { key: "payment-gateway", label: "Payment Gateway", path: "/payment-gateway" },
  { key: "invoices", label: "Invoices", path: "/invoices" },
  { key: "notifications", label: "Notifications", path: "/notifications" },
  { key: "notification-center", label: "Notification Center", path: "/notification-center" },
  ...
  { key: "daily-plans", label: "Daily Plans", path: "/daily-plans" },
