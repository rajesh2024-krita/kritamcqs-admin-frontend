...
import { ListStylesPage } from "../pages/listStyles/ListStylesPage";
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="list-styles" element={<ModuleAccess moduleKey="list-styles"><ListStylesPage /></ModuleAccess>} />
        ...
        <Route path="offer-timer-management" element={<MainAdminOnly><WebsiteContentPage /></MainAdminOnly>} />
