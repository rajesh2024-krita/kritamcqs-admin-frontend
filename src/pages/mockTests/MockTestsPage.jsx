...
const PRESET_CONFIG = {
  NEET_REAL: {
    ...
    instructions: [
      "Physics: Section A 35 compulsory and Section B 15 where only 10 are evaluated.",
      "Chemistry: Section A 35 compulsory and Section B 15 where only 10 are evaluated.",
      "Biology: Section A 70 compulsory and Section B 30 where only 20 are evaluated.",
      "Correct answer +4, wrong answer -1, unattempted 0.",
      "If more Section B questions are attempted, only the first valid attempts should count.",
    ],
  },
  JEE_REAL: {
    examType: "JEE",
    ...
    instructions: [
      "Physics, Chemistry, and Maths each contain 20 MCQs and 10 numerical questions.",
      "Attempt all MCQs and only 5 numerical questions per subject.",
      "MCQ marking: correct +4, wrong -1, unanswered 0.",
      "Numerical marking: correct +4, wrong 0.",
