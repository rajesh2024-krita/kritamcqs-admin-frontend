    ...
    <div className="flex flex-col gap-6">
      ...
      <section className={ui.panel}>
        ...
        <div className="grid gap-4 text-sm text-slate-700 lg:grid-cols-2">
          ...
          <div className="rounded-lg border border-slate-200 bg-slate-50 p-4"><strong>Examples</strong><p className="mt-2"><code>/subscription</code><br /><code>/mock-tests</code><br /><code>https://app.kritamcqs.com/#/subscription</code><br /><code>https://kritamcqs.com</code><br /><code>{"kritamcqs://subscription?plan={{plan_id}}"}</code><br /><code>{"/profile?ref={{referral_code}}"}</code></p></div>
        </div>
      </section>
