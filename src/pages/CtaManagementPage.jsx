    ...
    <div className="flex flex-col gap-6">
      ...
      <section className={ui.panel}>
        <form onSubmit={save} className="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <Field label="CTA URL / Deep Link" className="lg:col-span-3"><input className={ui.input} value={form.ctaUrl} onChange={(event) => patch({ ctaUrl: event.target.value })} placeholder="https://app.kritamcqs.com/subscription?user={{user_id}}" /></Field>
